...
PT = {
    ...
    "summary_rows": [
        ...
        ["Participação agregada", "Consultar snapshot atual", "Dado dinâmico"],
    ...
    "sections": [
        ...
        ("A PESSOA CRIADORA E SUAS HOLDINGS", ["A pessoa criadora mantém PELOCO em três carteiras declaradas e sob seu controle. Como os saldos mudam, a participação agregada atual não é fixada neste documento: ela deve ser consultada no snapshot on-chain datado da página Transparência.", "Carteiras declaradas:", WALLETS, "A intenção declarada é manter a posição no longo prazo e abaixo de 5% do supply. O objetivo de 4,8% a 4,9% e o lock de 2 anos são planos, ainda não condições implementadas.", "O mecanismo do lock deverá ser divulgado publicamente e ser verificável antes da implementação."]),
...
EN = {
    ...
    "summary_rows": [
        ...
        ["Aggregate position", "See current snapshot", "Dynamic data"],
    ...
    "sections": [
        ...
        ("THE CREATOR AND THEIR HOLDINGS", ["The creator holds PELOCO across three declared wallets under their control. Because balances change, the current aggregate share is not fixed in this document; it must be checked in the dated on-chain snapshot on the Transparency page.", "Declared wallets:", WALLETS, "The declared intention is to hold the position long term and keep it below 5% of the Total Supply. The 4.8% to 4.9% target and the 2-year lock are plans, not implemented conditions.", "The lock mechanism must be publicly disclosed and verifiable before implementation."]),
        ...
        ("WHAT WE DO NOT PROMISE", ["We do not promise profit, appreciation, financial return, a minimum price, a specific Market Cap, a specific holder count, protection from losses, manipulation, technical failures, other risks, or guaranteed success.", "Memecoins are highly speculative. We do not promise zero risk; we promise to make the risks visible."]),
