      ...
      const ORBIS_RESIDENTS = [
        {
          name: "PELOCO", src: "orbis-peloco.webp", species: ["Pintinho", "Chick", "Pollito"], role: ["Protagonista", "Protagonist", "Protagonista"],
          profession: ["Construtor de comunidades", "Community builder", "Constructor de comunidades"],
          story: ["Transforma vínculos pequenos em construção pública, ouvindo antes de reunir.", "He turns small bonds into public building, listening before bringing others together.", "Transforma pequeños vínculos en construcción pública, escuchando antes de reunir."],
        },
        {
          name: "Vulpira", src: "orbis-vulpira.webp", species: ["Raposa", "Fox", "Zorra"], role: ["Inteligência e coragem", "Insight and courage", "Ingenio y coraje"], origin: ["Japão · Tóquio", "Japan · Tokyo", "Japón · Tokio"],
          profession: ["Designer de moda urbana", "Urban fashion designer", "Diseñadora de moda urbana"],
          story: ["Lê o ritmo de Tóquio e transforma movimento, tradição e precisão em identidade visual.", "She reads Tokyo's rhythm and turns movement, tradition, and precision into visual identity.", "Lee el ritmo de Tokio y transforma movimiento, tradición y precisión en identidad visual."],
        },
        {
          name: "Fidelis", src: "orbis-fidelis.webp", species: ["Cão", "Dog", "Perro"], role: ["Lealdade e cuidado", "Loyalty and care", "Lealtad y cuidado"], origin: ["Escócia · Edimburgo", "Scotland · Edinburgh", "Escocia · Edimburgo"],
          profession: ["Restaurador comunitário", "Community restorer", "Restaurador comunitario"],
          story: ["Em Edimburgo, recupera lugares antigos para que novas histórias possam começar.", "In Edinburgh, he restores old places so new stories can begin.", "En Edimburgo, restaura lugares antiguos para que nuevas historias puedan comenzar."],
        },
        {
          name: "Anatis", src: "orbis-anatis.webp", species: ["Pato", "Duck", "Pato"], role: ["Curiosidade e movimento", "Curiosity and motion", "Curiosidad y movimiento"], origin: ["Irlanda · Dublin", "Ireland · Dublin", "Irlanda · Dublín"],
          profession: ["Cartógrafo e mensageiro", "Cartographer and messenger", "Cartógrafo y mensajero"],
          story: ["Mapeia caminhos por Dublin e conecta comunidades que ainda não se conhecem.", "He maps routes through Dublin and connects communities that have yet to meet.", "Traza rutas por Dublín y conecta comunidades que aún no se conocen."],
        },
        {
          name: "Porcellus", src: "orbis-porcellus.webp", species: ["Porco", "Pig", "Cerdo"], role: ["Alegria e abundância", "Joy and abundance", "Alegría y abundancia"], origin: ["Inglaterra · Londres", "England · London", "Inglaterra · Londres"],
          profession: ["Jornalista independente", "Independent journalist", "Periodista independiente"],
          story: ["Circula por Londres registrando fatos com humor, sem transformar rumor em verdade.", "He moves through London recording facts with humor, never turning rumor into truth.", "Recorre Londres registrando hechos con humor, sin convertir rumores en verdad."],
        },
        {
          name: "Noctua", src: "orbis-noctua.webp", species: ["Coruja", "Owl", "Búho"], role: ["Sabedoria e observação", "Wisdom and observation", "Sabiduría y observación"], origin: ["Grécia · Atenas", "Greece · Athens", "Grecia · Atenas"],
          profession: ["Pesquisadora e arquivista", "Researcher and archivist", "Investigadora y archivista"],
          story: ["Em Atenas, preserva a memória do universo e verifica cada relato antes de arquivá-lo.", "In Athens, she preserves the universe's memory and verifies every account before archiving it.", "En Atenas, preserva la memoria del universo y verifica cada relato antes de archivarlo."],
        },
      ];
      const copy = {
        pt: {
